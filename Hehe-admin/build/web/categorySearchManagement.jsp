                                                ...
                                                <tbody>
                                                    <c:forEach var="searchCate" items="${requestScope.searchCate}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input style="width:100%;border: none;border-bottom: 1px solid black;" type="text" name="cateName" value="${searchCate.getCategoryName()}" required></td>
                                                            <td><input style="width:100%;border: none;border-bottom: 1px solid black;"  type="text" name="cateDes" value="${searchCate.getDescription()}" required></td>
