...
public class Constants {
    ...
    public static String GOOGLE_REDIRECT_URI_AUTHOR = "http://localhost:8084/Hehe-admin/login-google-author";
    public static String GOOGLE_REDIRECT_URI_ADMIN = "http://localhost:8084/Hehe-admin/login-google-admin";
